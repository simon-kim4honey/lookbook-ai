...
const GUARDS = [
  ...
  {
    name: '누끼컷 — 두 이미지는 서로 다른 무관한 상품이라는 명시',
  ...
  {
    name: '누끼컷 — 샘플 이미지는 렌더링 기법/구도 참조 전용, 형태(길이·컷·실루엣)는 절대 참조 안 함',
  ...
  {
    name: '누끼컷 — 샘플 의류 복사 시 치명적 실패로 명시(HARD_CONSTRAINTS)',
  ...
  {
    name: '누끼컷 — 의류 길이/실루엣을 샘플에 맞춰 바꾸지 말 것(HARD_CONSTRAINTS)',
  ...
  {
    name: '누끼컷 — 소재/컬러 절대 변경 금지(HARD_CONSTRAINTS)',
  ...
  {
    name: '누끼컷 디테일컷 — 크롭/줌일 뿐 새로운 디자인 해석 금지',
    ...
    why: '디테일컷은 생성된 누끼컷 이미지의 특정 부위를 클로즈업하는 것일 뿐, AI가 새로운 디자인으로 재해석하면 안 된다. 이 문구가 없으면 클로즈업 과정에서 디자인/색상이 미묘하게 바뀔 위험이 있음.',
  },
  {
    name: '누끼컷 디테일컷 — 배경 화이트/무그림자 유지',
    must: "Background MUST remain pure solid white (#FFFFFF), completely flat and shadowless",
    why: '디테일컷도 원본 누끼컷 이미지와 동일하게 순백색·무그림자 배경을 유지해야 함을 명시.',
  },
  {
    name: '누끼컷 디테일컷 — 원본에 없는 워싱/디스트레싱/에이징 임의 추가 금지',
  ...
  {
    name: '누끼컷 디테일컷 — 새 사진이 아닌 원본의 크롭/줌일 뿐임을 명시',
  ...
  {
    name: '누끼컷 디테일컷 — 창작적 변경 전면 금지(질감/구김/비율/조명 등)',
