...
</html>`;K.get(`/share/:jobId/:idx`,async e=>{let t=e.env.LOOKBOOK_DB,n=e.req.param(`jobId`),r=parseInt(e.req.param(`idx`)||`0`,10),i=t=>{let i=`${$(e)}/share/${n}/${r}`,a=``;if(t.state===`ok`){let e=t.sourceTabs||[],n=e.length>0?`
          <div class="share-tabs">
            ${e.map(e=>`<button class="share-tab" data-url="${e.url}" onclick="_switchShareTab(this)">${e.label}</button>`).join(``)}
          </div>`:``,r=t.resultTab&&e.length>0?`
