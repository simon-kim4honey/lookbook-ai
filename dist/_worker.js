      ...
      <span id="ctaLabel" data-i18n="pkg-btn">패키지를 선택하세요</span>
        ...
        <div class="share-card">
          ...
          <div class="share-img-wrap">
            ${t.isVideo?`<video id="shareMainImg" src="${t.imageUrl}" class="share-img" autoplay loop muted playsinline controls></video>`:`<img id="shareMainImg" src="${t.imageUrl}" alt="EZlook 생성 이미지" class="share-img" />`}
          </div>
