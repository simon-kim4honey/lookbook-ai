...
<script src="/static/app.js"><\/script>
...
</html>`;U.get(`/`,e=>e.redirect(`/generator`,302)),U.get(`/_home`,e=>e.html(rt(`홈`,`
  <!-- Toast Container -->
  ...
  `))),U.get(`/dashboard`,e=>e.html(rt(`대시보드`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  `))),U.get(`/generator`,e=>e.html(rt(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
...
</html>`)),U.get(`/studio-b`,e=>e.redirect(`/`)),U.get(`/studio-b/*`,e=>{let t=e.req.path.replace(`/studio-b`,``)||`/`;return e.redirect(t)});var it=new xe,at=Object.assign({"/src/index.tsx":U}),ot=!1;for(let[,e]of Object.entries(at))e&&(it.all(`*`,t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),it.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),ot=!0);if(!ot)throw Error(`Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']`);export{it as default};