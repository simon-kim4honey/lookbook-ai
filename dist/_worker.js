...
<body>
...
</html>`)),G.get(`/_home_old`,e=>e.redirect(`/generator`,302)),G.get(`/`,e=>e.html(St(`홈`,`
  <!-- Toast Container -->
  ...
  `))),G.get(`/dashboard`,e=>e.html(St(`내 프로필`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  <\/script>
  `))),G.get(`/generator`,e=>e.html(St(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
