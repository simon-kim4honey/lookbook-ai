...
<body>
...
</html>`)),W.get(`/_home_old`,e=>e.redirect(`/generator`,302)),W.get(`/`,e=>e.html(vt(`홈`,`
  <!-- Toast Container -->
  ...
  `))),W.get(`/dashboard`,e=>e.html(vt(`내 프로필`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  <\/script>
  `))),W.get(`/generator`,e=>e.html(vt(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
...
</html>`));var yt=new xe,bt=Object.assign({"/src/index.tsx":W}),xt=!1;for(let[,e]of Object.entries(bt))e&&(yt.all(`*`,t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),yt.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),xt=!0);if(!xt)throw Error(`Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']`);export{yt as default};