...
<body>
...
</html>`)),G.get(`/_home_old`,e=>e.redirect(`/generator`,302)),G.get(`/`,e=>e.html(mt(`홈`,`
  <!-- Toast Container -->
  ...
  `))),G.get(`/dashboard`,e=>e.html(mt(`내 프로필`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  <\/script>
  `))),G.get(`/generator`,e=>e.html(mt(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
...
</html>`));var ht=new be,gt=Object.assign({"/src/index.tsx":G}),_t=!1;for(let[,e]of Object.entries(gt))e&&(ht.all(`*`,t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),ht.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),_t=!0);if(!_t)throw Error(`Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']`);export{ht as default};