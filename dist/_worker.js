...
<script src="/static/app.js"><\/script>
...
</html>`;U.get(`/`,e=>e.redirect(`/generator`,302)),U.get(`/_home`,e=>e.html(tt(`홈`,`
  <!-- Toast Container -->
  ...
  `))),U.get(`/dashboard`,e=>e.html(tt(`대시보드`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  `))),U.get(`/generator`,e=>e.html(tt(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
...
</html>`)),U.get(`/studio-b`,e=>e.redirect(`/`)),U.get(`/studio-b/*`,e=>{let t=e.req.path.replace(`/studio-b`,``)||`/`;return e.redirect(t)});var nt=new xe,rt=Object.assign({"/src/index.tsx":U}),it=!1;for(let[,e]of Object.entries(rt))e&&(nt.all(`*`,t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),nt.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),it=!0);if(!it)throw Error(`Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']`);export{nt as default};