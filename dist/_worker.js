...
<body>
...
</html>`)),W.get(`/_home_old`,e=>e.redirect(`/generator`,302)),W.get(`/`,e=>e.html(Ct(`홈`,`
  <!-- Toast Container -->
  ...
  `))),W.get(`/dashboard`,e=>e.html(Ct(`내 프로필`,`
  <div class="toast-container" id="toastContainer"></div>
  ...
  <\/script>
  `))),W.get(`/generator`,e=>e.html(Ct(`AI 룩북 생성`,`
  <div class="toast-container" id="toastContainer"></div>
...
</html>`));var wt=new xe,Tt=Object.assign({"/src/index.tsx":W}),Et=!1;for(let[,e]of Object.entries(Tt))e&&(wt.all(`*`,t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),wt.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),Et=!0);if(!Et)throw Error(`Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']`);export{wt as default};