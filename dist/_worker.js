...
</html>`)),K.get(`/_home_old`,e=>e.redirect(`/generator`,302)),K.get(`/`,e=>(e.req.header(`host`)||``).includes(`studiob.aifashion.co.kr`)?e.redirect(`/generator`,302):e.html(pt(`홈`,`
  <!-- Toast Container -->
